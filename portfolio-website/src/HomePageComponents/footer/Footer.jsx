    ...
    return (
        <footer className='footer'>
          ...
          <ul className='permalinks'>
            <li><a smooth="true" href="/#home">Home</a></li>
            <li><a smooth="true" href="/#about">About</a></li>
            <li><a smooth="true" href="/#experience">Experiences</a></li>
            <li><a smooth="true" href="/#contact">Contact</a></li>
          </ul>
