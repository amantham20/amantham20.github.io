       ...
       <div className='content_iam_sm lg-md-none'>
        ...
        <table>
            ...
            <tr>
                <th></th>
                <th>
                    <h1 className="txt rest top3">a Gamer</h1>
                </th>
            </tr>
            <tr>
                <th></th>
                <th>
                    <h1 className="txt rest top2">a Tech enthusiast</h1>
                </th>
            </tr>
            <tr>
                <th></th>
                <th>
                    <h1 className="txt rest top1">a Front end developer</h1>
                </th>
            </tr>
            <tr>
                <th>
                    <h1 className="txt center">Hey, I am&nbsp;</h1>
                </th>
                <th>
                    <h1 className="txt center">Aman Dhruva Thamminana</h1>
                </th>
            </tr>
            <tr>
                <th></th>
                <th>
                    <h1 className="txt rest bottom1">a Programmer</h1>
                </th>
            </tr>
            <tr>
                <th></th>
            ...
            <tr>
                <th></th>
                <th>
                    <h1 className="txt rest bottom3">an Engineer</h1>
                </th>
            </tr>
            </tbody>
        </table>
